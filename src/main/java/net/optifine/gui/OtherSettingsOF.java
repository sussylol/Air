...
public class OtherSettingsOF extends Screen implements GuiYesNoCallback {
    ...
    public OtherSettingsOF(Screen guiscreen, GameSettings gamesettings) {
    ...
    protected void actionPerformed(GuiButton guibutton) {
        if (guibutton.enabled) {
            ...
            if (guibutton.id == 210) {
                this.mc.gameSettings.saveOptions();
                YesNo guiyesno = new YesNo(this, I18n.format("of.message.other.reset"), "", 9999);
