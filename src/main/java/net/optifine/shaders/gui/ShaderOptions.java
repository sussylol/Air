...
public class ShaderOptions extends ScreenOF {
    ...
    public ShaderOptions(Screen guiscreen, GameSettings gamesettings) {
    ...
    public ShaderOptions(Screen guiscreen, GameSettings gamesettings, String screenName) {
        ...
        if (guibutton.enabled) {
            if (guibutton.id < 200 && guibutton instanceof GuiButtonShaderOption) {
                ...
                if (shaderoption instanceof ShaderOptionScreen) {
                    ...
                    ShaderOptions guishaderoptions = new ShaderOptions(this, this.settings, s);
