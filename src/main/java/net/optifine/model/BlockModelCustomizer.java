...
public class BlockModelCustomizer {
    ...
    public static List<BakedQuad> getRenderQuads(List<BakedQuad> quads, IBlockAccess worldIn, IBlockState stateIn, BlockPos posIn, Direction enumfacing, EnumWorldBlockLayer layer, long rand, RenderEnv renderEnv) {
        if (enumfacing != null) {
