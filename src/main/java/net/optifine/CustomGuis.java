...
public class CustomGuis {
    ...
    public static ResourceLocation getTextureLocation(ResourceLocation loc) {
        if (guiProperties == null) {
            ...
            if (!(guiscreen instanceof Container)) {
                return loc;
