...
public class BlockCocoa extends BlockDirectional implements IGrowable {
    ...
    public BlockCocoa() {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(FACING, Direction.NORTH).withProperty(AGE, Integer.valueOf(0)));
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(FACING, Direction.getHorizontal(meta)).withProperty(AGE, Integer.valueOf((meta & 15) >> 2));
    }
