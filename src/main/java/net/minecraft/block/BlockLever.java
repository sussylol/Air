...
public class BlockLever extends Block {
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, Direction facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        ...
        if (func_181090_a(worldIn, pos, facing.getOpposite())) {
            ...
            if (World.doesBlockHaveSolidTopSurface(worldIn, pos.down())) {
                return iblockstate.withProperty(FACING, BlockLever.EnumOrientation.forFacings(Direction.UP, placer.getHorizontalFacing()));
            } else {
                return iblockstate;
            }
        }
    ...
    public enum EnumOrientation implements IStringSerializable {
        ...
        public static BlockLever.EnumOrientation forFacings(Direction clickedSide, Direction entityFacing) {
            switch (clickedSide) {
                case DOWN:
