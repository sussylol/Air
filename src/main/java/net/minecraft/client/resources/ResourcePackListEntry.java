...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry {
    ...
    protected final ScreenResourcePacks resourcePacksGUI;

    public ResourcePackListEntry(ScreenResourcePacks resourcePacksGUIIn) {
        ...
        if (this.func_148310_d() && p_148278_5_ <= 32) {
            if (this.func_148309_e()) {
                ...
                if (j != 1) {
                    ...
                    this.mc.displayGuiScreen(new YesNo(new GuiYesNoCallback() {
