...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        try {
            ...
            float f1 = this.interpolateRotation(entity.prevRenderYawHead, entity.renderYawHead, partialTicks);
            float f2 = f1 - f;
            ...
            if (entity == MinecraftInstance.mc.player) f7 = entity.prevRenderPitchHead + (entity.renderPitchHead - entity.prevRenderPitchHead) * partialTicks;
