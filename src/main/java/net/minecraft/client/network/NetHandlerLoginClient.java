...
public class NetHandlerLoginClient implements INetHandlerLoginClient {
    ...
    public void handleLoginSuccess(S02PacketLoginSuccess packetIn) {
        ...
        this.networkManager.setNetHandler(new NetHandlerPlayClient(this.mc, this.previousScreen, this.networkManager, gameProfile));
    }
    ...
    public void onDisconnect(IChatComponent reason) {
        this.mc.displayGuiScreen(new Disconnected(this.previousScreen, "connect.failed", reason));
    }
