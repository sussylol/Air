...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn) {
        ...
        this.gameController.displayGuiScreen(new DownloadTerrain(this));
    ...
    public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
        ...
        if (packetIn.getType() == 10) {
            ...
            entity = new EntityItemFrame(this.clientWorldController, new BlockPos(MathHelper.floor_double(d0), MathHelper.floor_double(d1), MathHelper.floor_double(d2)), Direction.getHorizontal(packetIn.func_149009_m()));
            packetIn.func_149002_g(0);
    ...
    public void handleSpawnMob(S0FPacketSpawnMob packetIn) {
        ...
        entitylivingbase.renderYawOffset = entitylivingbase.renderYawHead = (float) (packetIn.getHeadPitch() * 360) / 256.0F;
    ...
    public void handleSetSlot(S2FPacketSetSlot packetIn) {
        ...
        if (packetIn.func_149175_c() == -1) {
            ...
            if (this.gameController.currentScreen instanceof ContainerCreative) {
                ContainerCreative guicontainercreative = (ContainerCreative) this.gameController.currentScreen;
    ...
    public void handleChangeGameState(S2BPacketChangeGameState packetIn) {
        ...
        if (i == 1) {
            ...
            this.gameController.displayGuiScreen(new WinGame());
        } else if (i == 5) {
            GameSettings gamesettings = this.gameController.gameSettings;

            if (f == 0.0F) {
                this.gameController.displayGuiScreen(new ScreenDemo());
            } else if (f == 101.0F) {
    ...
    public void handleTabComplete(S3APacketTabComplete packetIn) {
        ...
        if (this.gameController.currentScreen instanceof Chat) {
            Chat guichat = (Chat) this.gameController.currentScreen;
        ...
        if (s.startsWith("level://")) {
            ...
            if (this.gameController.getCurrentServerData() != null && this.gameController.getCurrentServerData().getResourceMode() == ServerData.ServerResourceMode.ENABLED) {
                ...
                this.gameController.addScheduledTask(new Runnable() {
                    public void run() {
                        NetHandlerPlayClient.this.gameController.displayGuiScreen(new YesNo(new GuiYesNoCallback() {
    ...
    public void handleCustomPayload(S3FPacketCustomPayload packetIn) {
        ...
        if ("MC|TrList".equals(packetIn.getChannelName())) {
            ...
            try {
                ...
                if (guiscreen != null && guiscreen instanceof Merchant && i == this.gameController.player.openContainer.windowId) {
                    IMerchant imerchant = ((Merchant) guiscreen).getMerchant();
            ...
            if (itemstack != null && itemstack.getItem() == Items.written_book) {
                this.gameController.displayGuiScreen(new ScreenBook(this.gameController.player, itemstack, false));
            }
        }
    }
