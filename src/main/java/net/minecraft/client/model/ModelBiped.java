...
import com.dev.air.module.impl.render.AnimationsMod;
...
public class ModelBiped extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        AnimationsMod animationsMod = (AnimationsMod) Client.instance.getModuleManager().get(AnimationsMod.class);
        if (animationsMod.isEnable() && animationsMod.walkAnimation.is("Old") && entityIn instanceof EntityPlayer) {
