...
public class CreateFlatWorld extends Screen {
    private final CreateWorld createWorldGui;
    ...
    private CreateFlatWorld.Details createFlatWorldListSlotGui;
    private GuiButton field_146389_t;
    private GuiButton field_146388_u;
    private GuiButton field_146386_v;

    public CreateFlatWorld(CreateWorld createWorldGuiIn, String p_i1029_2_) {
    ...
    public void initGui() {
        ...
        this.createFlatWorldListSlotGui = new CreateFlatWorld.Details();
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 1) {
            ...
            this.mc.displayGuiScreen(new FlatPresets(this));
    ...
    class Details extends GuiSlot {
        ...
        public Details() {
            super(CreateFlatWorld.this.mc, CreateFlatWorld.this.width, CreateFlatWorld.this.height, 43, CreateFlatWorld.this.height - 60, 24);
        }
        ...
        private void func_148225_a(int p_148225_1_, int p_148225_2_, ItemStack p_148225_3_) {
            ...
            if (p_148225_3_ != null && p_148225_3_.getItem() != null) {
                ...
                CreateFlatWorld.this.itemRender.renderItemIntoGUI(p_148225_3_, p_148225_1_ + 2, p_148225_2_ + 2);
        ...
        private void func_148224_c(int p_148224_1_, int p_148224_2_, int p_148224_3_, int p_148224_4_) {
            ...
            worldrenderer.pos(p_148224_1_, p_148224_2_ + 18, CreateFlatWorld.this.zLevel).tex((float) (p_148224_3_) * 0.0078125F, (float) (p_148224_4_ + 18) * 0.0078125F).endVertex();
            worldrenderer.pos(p_148224_1_ + 18, p_148224_2_ + 18, CreateFlatWorld.this.zLevel).tex((float) (p_148224_3_ + 18) * 0.0078125F, (float) (p_148224_4_ + 18) * 0.0078125F).endVertex();
            worldrenderer.pos(p_148224_1_ + 18, p_148224_2_, CreateFlatWorld.this.zLevel).tex((float) (p_148224_3_ + 18) * 0.0078125F, (float) (p_148224_4_) * 0.0078125F).endVertex();
            worldrenderer.pos(p_148224_1_, p_148224_2_, CreateFlatWorld.this.zLevel).tex((float) (p_148224_3_) * 0.0078125F, (float) (p_148224_4_) * 0.0078125F).endVertex();
            tessellator.draw();
        }

        protected int getSize() {
            return CreateFlatWorld.this.theFlatGeneratorInfo.getFlatLayers().size();
        }

        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
            this.field_148228_k = slotIndex;
            CreateFlatWorld.this.func_146375_g();
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            FlatLayerInfo flatlayerinfo = CreateFlatWorld.this.theFlatGeneratorInfo.getFlatLayers().get(CreateFlatWorld.this.theFlatGeneratorInfo.getFlatLayers().size() - entryID - 1);
            ...
            CreateFlatWorld.this.fontRendererObj.drawString(s, p_180791_2_ + 18 + 5, p_180791_3_ + 3, 16777215);
            String s1;

            if (entryID == 0) {
                s1 = I18n.format("createWorld.customize.flat.layer.top", Integer.valueOf(flatlayerinfo.getLayerCount()));
            } else if (entryID == CreateFlatWorld.this.theFlatGeneratorInfo.getFlatLayers().size() - 1) {
            ...
            CreateFlatWorld.this.fontRendererObj.drawString(s1, p_180791_2_ + 2 + 213 - CreateFlatWorld.this.fontRendererObj.getStringWidth(s1), p_180791_3_ + 3, 16777215);
        }
