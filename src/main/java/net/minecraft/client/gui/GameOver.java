...
public class GameOver extends Screen implements GuiYesNoCallback {
    /**
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("deathScreen.score") + ": " + EnumChatFormatting.YELLOW + this.mc.player.getScore(), this.width / 2, 100, 16777215);
