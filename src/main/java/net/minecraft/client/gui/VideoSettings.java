...
import net.optifine.shaders.gui.Shaders;

import java.io.IOException;

public class VideoSettings extends ScreenOF {
    ...
    public VideoSettings(Screen parentScreenIn, GameSettings gameSettingsIn) {
    ...
    private void actionPerformed(GuiButton p_actionPerformed_1_, int p_actionPerformed_2_) {
        if (p_actionPerformed_1_.enabled) {
            ...
            if (p_actionPerformed_1_.id == 201) {
                this.mc.gameSettings.saveOptions();
                DetailSettingsOF guidetailsettingsof = new DetailSettingsOF(this, this.guiGameSettings);
                this.mc.displayGuiScreen(guidetailsettingsof);
            }

            if (p_actionPerformed_1_.id == 202) {
                this.mc.gameSettings.saveOptions();
                QualitySettingsOF guiqualitysettingsof = new QualitySettingsOF(this, this.guiGameSettings);
                this.mc.displayGuiScreen(guiqualitysettingsof);
            }

            if (p_actionPerformed_1_.id == 211) {
                this.mc.gameSettings.saveOptions();
                AnimationSettingsOF guianimationsettingsof = new AnimationSettingsOF(this, this.guiGameSettings);
                this.mc.displayGuiScreen(guianimationsettingsof);
            }

            if (p_actionPerformed_1_.id == 212) {
                this.mc.gameSettings.saveOptions();
                PerformanceSettingsOF guiperformancesettingsof = new PerformanceSettingsOF(this, this.guiGameSettings);
                this.mc.displayGuiScreen(guiperformancesettingsof);
            }

            if (p_actionPerformed_1_.id == 222) {
                this.mc.gameSettings.saveOptions();
                OtherSettingsOF guiothersettingsof = new OtherSettingsOF(this, this.guiGameSettings);
            ...
            if (p_actionPerformed_1_.id == 231) {
                ...
                this.mc.gameSettings.saveOptions();
                Shaders guishaders = new Shaders(this, this.guiGameSettings);
    ...
    public static String getGuiChatText(Chat p_getGuiChatText_0_) {
