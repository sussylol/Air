...
public class CustomizeWorldScreen extends Screen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
    private final CreateWorld field_175343_i;
    ...
    public CustomizeWorldScreen(Screen p_i45521_1_, String p_i45521_2_) {
        this.field_175343_i = (CreateWorld) p_i45521_1_;
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            switch (button.id) {
                ...
                case 305:
                    this.mc.displayGuiScreen(new ScreenCustomizePresets(this));
                    break;
