...
public class ScreenOptionsSounds extends Screen {
    ...
    public ScreenOptionsSounds(Screen p_i45025_1_, GameSettings p_i45025_2_) {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new ScreenOptionsSounds.Button(SoundCategory.MASTER.getCategoryId(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), SoundCategory.MASTER, true));
        i = i + 2;

        for (SoundCategory soundcategory : SoundCategory.values()) {
            if (soundcategory != SoundCategory.MASTER) {
                this.buttonList.add(new ScreenOptionsSounds.Button(soundcategory.getCategoryId(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), soundcategory, false));
                ++i;
            }
        }
    ...
    class Button extends GuiButton {
        ...
        public Button(int p_i45024_2_, int p_i45024_3_, int p_i45024_4_, SoundCategory p_i45024_5_, boolean p_i45024_6_) {
            ...
            this.displayString = this.field_146152_s + ": " + ScreenOptionsSounds.this.getSoundVolume(p_i45024_5_);
            this.field_146156_o = ScreenOptionsSounds.this.game_settings_4.getSoundLevel(p_i45024_5_);
        }
        ...
        protected void mouseDragged(Minecraft mc, int mouseX, int mouseY) {
            if (this.visible) {
                if (this.field_146155_p) {
                    ...
                    this.displayString = this.field_146152_s + ": " + ScreenOptionsSounds.this.getSoundVolume(this.field_146153_r);
                }
        ...
        public void mouseReleased(int mouseX, int mouseY) {
            if (this.field_146155_p) {
                if (this.field_146153_r == SoundCategory.MASTER) {
                    ...
                    ScreenOptionsSounds.this.game_settings_4.getSoundLevel(this.field_146153_r);
                }

                ScreenOptionsSounds.this.mc.getSoundHandler().playSound(PositionedSoundRecord.create(new ResourceLocation("gui.button.press"), 1.0F));
            }
