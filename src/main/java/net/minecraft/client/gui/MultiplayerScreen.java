...
public class MultiplayerScreen extends Screen implements GuiYesNoCallback {
        ...
        if (button.enabled) {
            ...
            if (button.id == 2 && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
                ...
                if (s4 != null) {
                    ...
                    YesNo guiyesno = new YesNo(this, s, s1, s2, s3, this.serverListSelector.func_148193_k());
                ...
                this.mc.displayGuiScreen(new ScreenServerList(this, this.selectedServer = new ServerData(I18n.format("selectServer.defaultName"), "", false)));
            } else if (button.id == 3) {
                this.addingServer = true;
                this.mc.displayGuiScreen(new ScreenAddServer(this, this.selectedServer = new ServerData(I18n.format("selectServer.defaultName"), "", false)));
                ...
                this.mc.displayGuiScreen(new ScreenAddServer(this, this.selectedServer));
            } else if (button.id == 0) {
    ...
    private void connectToServer(ServerData server) {
        this.mc.displayGuiScreen(new Connecting(this, this.mc, server));
    }
