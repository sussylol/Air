...
public class Beacon extends Container {
    ...
    private Beacon.ConfirmButton beaconConfirmButton;
    private boolean buttonsNotDrawn;

    public Beacon(InventoryPlayer playerInventory, IInventory tileBeaconIn) {
    ...
    public void initGui() {
        super.initGui();
        this.buttonList.add(this.beaconConfirmButton = new Beacon.ConfirmButton(-1, this.guiLeft + 164, this.guiTop + 107));
        this.buttonList.add(new Beacon.CancelButton(-2, this.guiLeft + 190, this.guiTop + 107));
        ...
        if (this.buttonsNotDrawn && i >= 0) {
            ...
            for (int l = 0; l <= 2; ++l) {
                ...
                for (int k1 = 0; k1 < i1; ++k1) {
                    ...
                    Beacon.PowerButton guibeacon$powerbutton = new Beacon.PowerButton(l << 8 | l1, this.guiLeft + 76 + k1 * 24 - j1 / 2, this.guiTop + 22 + l * 25, l1, l);
            ...
            for (int l2 = 0; l2 < j2 - 1; ++l2) {
                ...
                Beacon.PowerButton guibeacon$powerbutton2 = new Beacon.PowerButton(i2 << 8 | i3, this.guiLeft + 167 + l2 * 24 - k2 / 2, this.guiTop + 47, i3, i2);
            ...
            if (j > 0) {
                Beacon.PowerButton guibeacon$powerbutton1 = new Beacon.PowerButton(i2 << 8 | j, this.guiLeft + 167 + (j2 - 1) * 24 - k2 / 2, this.guiTop + 47, j, i2);
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == -2) {
            ...
            this.mc.displayGuiScreen(null);
        } else if (button instanceof Beacon.PowerButton) {
            if (((Beacon.PowerButton) button).func_146141_c()) {
                return;
            }
    ...
    static class Button extends GuiButton {
        ...
        public void drawButton(Minecraft mc, int mouseX, int mouseY) {
            if (this.visible) {
                mc.getTextureManager().bindTexture(Beacon.beaconGuiTextures);
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                ...
                if (!Beacon.beaconGuiTextures.equals(this.field_146145_o)) {
    ...
    class CancelButton extends Beacon.Button {
        public CancelButton(int p_i1074_2_, int p_i1074_3_, int p_i1074_4_) {
            super(p_i1074_2_, p_i1074_3_, p_i1074_4_, Beacon.beaconGuiTextures, 112, 220);
        }

        public void drawButtonForegroundLayer(int mouseX, int mouseY) {
            Beacon.this.drawCreativeTabHoveringText(I18n.format("gui.cancel"), mouseX, mouseY);
        }
    }

    class ConfirmButton extends Beacon.Button {
        public ConfirmButton(int p_i1075_2_, int p_i1075_3_, int p_i1075_4_) {
            super(p_i1075_2_, p_i1075_3_, p_i1075_4_, Beacon.beaconGuiTextures, 90, 220);
        }

        public void drawButtonForegroundLayer(int mouseX, int mouseY) {
            Beacon.this.drawCreativeTabHoveringText(I18n.format("gui.done"), mouseX, mouseY);
        }
    }

    class PowerButton extends Beacon.Button {
        ...
        public PowerButton(int p_i1076_2_, int p_i1076_3_, int p_i1076_4_, int p_i1076_5_, int p_i1076_6_) {
            super(p_i1076_2_, p_i1076_3_, p_i1076_4_, Container.inventoryBackground, Potion.potionTypes[p_i1076_5_].getStatusIconIndex() % 8 * 18, 198 + Potion.potionTypes[p_i1076_5_].getStatusIconIndex() / 8 * 18);
        ...
        public void drawButtonForegroundLayer(int mouseX, int mouseY) {
            ...
            Beacon.this.drawCreativeTabHoveringText(s, mouseX, mouseY);
        }
    }
}
