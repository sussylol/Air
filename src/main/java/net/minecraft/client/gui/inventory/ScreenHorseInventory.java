...
public class ScreenHorseInventory extends Container {
    ...
    public ScreenHorseInventory(IInventory playerInv, IInventory horseInv, EntityHorse horse) {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        Inventory.drawEntityOnScreen(i + 51, j + 60, 17, (float) (i + 51) - this.mousePosx, (float) (j + 75 - 50) - this.mousePosY, this.horseEntity);
    }
