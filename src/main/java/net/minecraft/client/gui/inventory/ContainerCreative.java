...
import net.minecraft.client.gui.achievement.Achievements;
...
public class ContainerCreative extends InventoryEffectRenderer {
    /**
    ...
    public ContainerCreative(EntityPlayer p_i1088_1_) {
        super(new ContainerCreativeOther(p_i1088_1_));
    ...
    public void updateScreen() {
        if (!this.mc.playerController.isInCreativeMode()) {
            this.mc.displayGuiScreen(new Inventory(this.mc.player));
        }
    ...
    protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType) {
        ...
        if (slotIn == null && selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && clickType != 5) {
            ...
            if (slotIn == this.field_147064_C) {
                this.mc.player.inventory.setItemStack(null);
                ...
                this.mc.player.inventoryContainer.slotClick(slotIn == null ? slotId : ((net.minecraft.client.gui.inventory.ContainerCreative.CreativeSlot) slotIn).slot.slotNumber, clickedButton, clickType, this.mc.player);
    ...
    private void updateCreativeSearch() {
        ContainerCreativeOther guicontainercreative$containercreative = (ContainerCreativeOther) this.inventorySlots;
    ...
    private boolean needsScrollBars() {
        return selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && CreativeTabs.creativeTabArray[selectedTabIndex].shouldHidePlayerInventory() && ((ContainerCreativeOther) this.inventorySlots).func_148328_e();
    }
    ...
    private void setCurrentCreativeTab(CreativeTabs p_147050_1_) {
        ...
        if (p_147050_1_ == CreativeTabs.tabInventory) {
            ...
            for (int j = 0; j < container.inventorySlots.size(); ++j) {
                Slot slot = new net.minecraft.client.gui.inventory.ContainerCreative.CreativeSlot(container.inventorySlots.get(j), j);
    ...
    public void handleMouseInput() throws IOException {
        ...
        if (i != 0 && this.needsScrollBars()) {
            int j = ((ContainerCreativeOther) this.inventorySlots).itemList.size() / 9 - 5;
            ...
            ((ContainerCreativeOther) this.inventorySlots).scrollTo(this.currentScroll);
        }
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (creativetabs == CreativeTabs.tabInventory) {
            Inventory.drawEntityOnScreen(this.guiLeft + 43, this.guiTop + 45, 20, (float) (this.guiLeft + 43 - mouseX), (float) (this.guiTop + 45 - 30 - mouseY), this.mc.player);
        }
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 0) {
            this.mc.displayGuiScreen(new Achievements(this, this.mc.player.getStatFileWriter()));
        }
...
//            this.mc.displayGuiScreen(new GuiStats(this, this.mc.thePlayer.getStatFileWriter()));
    ...
    static class ContainerCreativeOther extends Container {
        public List<ItemStack> itemList = Lists.newArrayList();

        public ContainerCreativeOther(EntityPlayer p_i1086_1_) {
            InventoryPlayer inventoryplayer = p_i1086_1_.inventory;

            for (int i = 0; i < 5; ++i) {
                for (int j = 0; j < 9; ++j) {
                    this.addSlotToContainer(new Slot(net.minecraft.client.gui.inventory.ContainerCreative.field_147060_v, i * 9 + j, 9 + j * 18, 18 + i * 18));
                }
            }
            ...
            for (int k = 0; k < 5; ++k) {
                for (int l = 0; l < 9; ++l) {
                    ...
                    if (i1 >= 0 && i1 < this.itemList.size()) {
                        net.minecraft.client.gui.inventory.ContainerCreative.field_147060_v.setInventorySlotContents(l + k * 9, this.itemList.get(i1));
                    } else {
                        net.minecraft.client.gui.inventory.ContainerCreative.field_147060_v.setInventorySlotContents(l + k * 9, null);
                    }
                }
            }
        }
