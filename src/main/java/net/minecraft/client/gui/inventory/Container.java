...
public abstract class Container extends Screen {
    /**
    ...
    public Container(net.minecraft.inventory.Container inventorySlotsIn) {
    ...
    private void drawSlot(Slot slotIn) {
        ...
        if (slotIn == this.clickedSlot && this.draggedStack != null && this.isRightMouseClick && itemstack != null) {
            ...
            if (net.minecraft.inventory.Container.canAddItemToSlot(slotIn, itemstack1, true) && this.inventorySlots.canDragIntoSlot(slotIn)) {
                itemstack = itemstack1.copy();
                flag = true;
                net.minecraft.inventory.Container.computeStackSize(this.dragSplittingSlots, this.dragSplittingLimit, itemstack, slotIn.getStack() == null ? 0 : slotIn.getStack().stackSize);
    ...
    private void updateDragSplitting() {
        ...
        if (itemstack != null && this.dragSplitting) {
            ...
            for (Slot slot : this.dragSplittingSlots) {
                ...
                net.minecraft.inventory.Container.computeStackSize(this.dragSplittingSlots, this.dragSplittingLimit, itemstack1, i);
    ...
    protected void mouseClickMove(int mouseX, int mouseY, int clickedMouseButton, long timeSinceLastClick) {
        ...
        if (this.clickedSlot != null && this.mc.gameSettings.touchscreen) {
            if (clickedMouseButton == 0 || clickedMouseButton == 1) {
                ...
                } else if (this.draggedStack.stackSize > 1 && slot != null && net.minecraft.inventory.Container.canAddItemToSlot(slot, this.draggedStack, false)) {
                    long i = Minecraft.getSystemTime();
        ...
        } else if (this.dragSplitting && slot != null && itemstack != null && itemstack.stackSize > this.dragSplittingSlots.size() && net.minecraft.inventory.Container.canAddItemToSlot(slot, itemstack, true) && slot.isItemValid(itemstack) && this.inventorySlots.canDragIntoSlot(slot)) {
        ...
        if (this.doubleClick && slot != null && state == 0 && this.inventorySlots.canMergeSlot(null, slot)) {
            if (isShiftKeyDown()) {
                if (slot != null && slot.inventory != null && this.shiftClickedSlot != null) {
                    for (Slot slot2 : this.inventorySlots.inventorySlots) {
                        if (slot2 != null && slot2.canTakeStack(this.mc.player) && slot2.getHasStack() && slot2.inventory == slot.inventory && net.minecraft.inventory.Container.canAddItemToSlot(slot2, this.shiftClickedSlot, true)) {
            ...
            if (this.clickedSlot != null && this.mc.gameSettings.touchscreen) {
                if (state == 0 || state == 1) {
                    ...
                    boolean flag2 = net.minecraft.inventory.Container.canAddItemToSlot(slot, this.draggedStack, false);
                ...
                this.handleMouseClick(null, -999, net.minecraft.inventory.Container.func_94534_d(0, this.dragSplittingLimit), 5);

                for (Slot slot1 : this.dragSplittingSlots) {
                    this.handleMouseClick(slot1, slot1.slotNumber, net.minecraft.inventory.Container.func_94534_d(1, this.dragSplittingLimit), 5);
                }

                this.handleMouseClick(null, -999, net.minecraft.inventory.Container.func_94534_d(2, this.dragSplittingLimit), 5);
