...
public class Repair extends Container implements ICrafting {
    ...
    public Repair(InventoryPlayer inventoryIn, World worldIn) {
     ...
     */
    public void updateCraftingInventory(net.minecraft.inventory.Container containerToSend, List<ItemStack> itemsList) {
     ...
     */
    public void sendProgressBarUpdate(net.minecraft.inventory.Container containerIn, int varToUpdate, int newValue) {
    }

    public void sendAllWindowProperties(net.minecraft.inventory.Container p_175173_1_, IInventory p_175173_2_) {
    }
}
