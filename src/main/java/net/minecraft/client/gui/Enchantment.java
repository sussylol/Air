...
public class Enchantment extends Container {
    /**
    ...
    public Enchantment(InventoryPlayer inventory, World worldIn, IWorldNameable p_i45502_3_) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (int j = 0; j < 3; ++j) {
            ...
            if (this.isPointInRegion(60, 14 + 19 * j, 108, 17, mouseX, mouseY) && k > 0 && l >= 0) {
                ...
                if (l >= 0 && net.minecraft.enchantment.Enchantment.getEnchantmentById(l & 255) != null) {
                    String s = net.minecraft.enchantment.Enchantment.getEnchantmentById(l & 255).getTranslatedName((l & 65280) >> 8);
