...
import net.minecraft.client.gui.inventory.Container;
...
public class Merchant extends Container {
     ...
     */
    private Merchant.MerchantButton nextButton;

    /**
     * Returns to the previous Merchant recipe if one is applicable.
     */
    private Merchant.MerchantButton previousButton;
    ...
    public Merchant(InventoryPlayer p_i45500_1_, IMerchant p_i45500_2_, World worldIn) {
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.nextButton = new Merchant.MerchantButton(1, i + 120 + 27, j + 24 - 1, true));
        this.buttonList.add(this.previousButton = new Merchant.MerchantButton(2, i + 36 - 19, j + 24 - 1, false));
    ...
    static class MerchantButton extends GuiButton {
        ...
        public void drawButton(Minecraft mc, int mouseX, int mouseY) {
            if (this.visible) {
                mc.getTextureManager().bindTexture(Merchant.MERCHANT_GUI_TEXTURE);
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
