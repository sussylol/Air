...
public class FlatPresets extends Screen {
    private static final List<FlatPresets.LayerItem> FLAT_WORLD_PRESETS = Lists.newArrayList();

    /**
     * The parent GUI
     */
    private final CreateFlatWorld parentScreen;
    private String presetsTitle;
    private String presetsShare;
    private String field_146436_r;
    private FlatPresets.ListSlot field_146435_s;
    private GuiButton field_146434_t;
    private GuiTextField field_146433_u;

    public FlatPresets(CreateFlatWorld p_i46318_1_) {
    ...
    public void initGui() {
        ...
        this.field_146435_s = new FlatPresets.ListSlot();
    ...
    private static void func_175354_a(String p_175354_0_, Item p_175354_1_, int p_175354_2_, BiomeGenBase p_175354_3_, List<String> p_175354_4_, FlatLayerInfo... p_175354_5_) {
        ...
        FLAT_WORLD_PRESETS.add(new FlatPresets.LayerItem(p_175354_1_, p_175354_2_, p_175354_0_, flatgeneratorinfo.toString()));
    }
    ...
    class ListSlot extends GuiSlot {
        ...
        public ListSlot() {
            super(FlatPresets.this.mc, FlatPresets.this.width, FlatPresets.this.height, 80, FlatPresets.this.height - 37, 24);
        }
        ...
        private void func_178054_a(int p_178054_1_, int p_178054_2_, Item p_178054_3_, int p_178054_4_) {
            ...
            FlatPresets.this.itemRender.renderItemIntoGUI(new ItemStack(p_178054_3_, 1, p_178054_4_), p_178054_1_ + 2, p_178054_2_ + 2);
        ...
        private void func_148171_c(int p_148171_1_, int p_148171_2_, int p_148171_3_, int p_148171_4_) {
            ...
            worldrenderer.pos(p_148171_1_, p_148171_2_ + 18, FlatPresets.this.zLevel).tex((float) (p_148171_3_) * 0.0078125F, (float) (p_148171_4_ + 18) * 0.0078125F).endVertex();
            worldrenderer.pos(p_148171_1_ + 18, p_148171_2_ + 18, FlatPresets.this.zLevel).tex((float) (p_148171_3_ + 18) * 0.0078125F, (float) (p_148171_4_ + 18) * 0.0078125F).endVertex();
            worldrenderer.pos(p_148171_1_ + 18, p_148171_2_, FlatPresets.this.zLevel).tex((float) (p_148171_3_ + 18) * 0.0078125F, (float) (p_148171_4_) * 0.0078125F).endVertex();
            worldrenderer.pos(p_148171_1_, p_148171_2_, FlatPresets.this.zLevel).tex((float) (p_148171_3_) * 0.0078125F, (float) (p_148171_4_) * 0.0078125F).endVertex();
            tessellator.draw();
        }

        protected int getSize() {
            return FlatPresets.FLAT_WORLD_PRESETS.size();
        }

        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
            this.field_148175_k = slotIndex;
            FlatPresets.this.func_146426_g();
            FlatPresets.this.field_146433_u.setText(FlatPresets.FLAT_WORLD_PRESETS.get(FlatPresets.this.field_146435_s.field_148175_k).field_148233_c);
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            FlatPresets.LayerItem guiflatpresets$layeritem = FlatPresets.FLAT_WORLD_PRESETS.get(entryID);
            ...
            FlatPresets.this.fontRendererObj.drawString(guiflatpresets$layeritem.field_148232_b, p_180791_2_ + 18 + 5, p_180791_3_ + 6, 16777215);
        }
    }
}
