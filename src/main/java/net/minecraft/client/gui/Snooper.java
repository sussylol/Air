...
public class Snooper extends Screen {
    ...
    private Snooper.List field_146606_s;
    private GuiButton field_146605_t;

    public Snooper(Screen p_i1061_1_, GameSettings p_i1061_2_) {
    ...
    public void initGui() {
        ...
        this.field_146606_s = new Snooper.List();
    }
    ...
    class List extends GuiSlot {
        public List() {
            super(Snooper.this.mc, Snooper.this.width, Snooper.this.height, 80, Snooper.this.height - 40, Snooper.this.fontRendererObj.FONT_HEIGHT + 1);
        }

        protected int getSize() {
            return Snooper.this.field_146604_g.size();
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            Snooper.this.fontRendererObj.drawString(Snooper.this.field_146604_g.get(entryID), 10, p_180791_3_, 16777215);
            Snooper.this.fontRendererObj.drawString(Snooper.this.field_146609_h.get(entryID), 230, p_180791_3_, 16777215);
        }
