...
public class ScreenBook extends Screen {
    ...
    private ScreenBook.NextPageButton buttonNextPage;
    private ScreenBook.NextPageButton buttonPreviousPage;
    ...
    public ScreenBook(EntityPlayer player, ItemStack book, boolean isUnsigned) {
    ...
    public void initGui() {
        ...
        int j = 2;
        this.buttonList.add(this.buttonNextPage = new ScreenBook.NextPageButton(1, i + 120, j + 154, true));
        this.buttonList.add(this.buttonPreviousPage = new ScreenBook.NextPageButton(2, i + 38, j + 154, false));
        this.updateButtons();
    }
    ...
    static class NextPageButton extends GuiButton {
        ...
        public void drawButton(Minecraft mc, int mouseX, int mouseY) {
            if (this.visible) {
                ...
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                mc.getTextureManager().bindTexture(ScreenBook.bookGuiTextures);
                int i = 0;
                int j = 192;
