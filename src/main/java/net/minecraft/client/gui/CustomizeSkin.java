...
import net.optifine.gui.ScreenCapeOF;

import java.io.IOException;

public class CustomizeSkin extends Screen {
    /**
    ...
    public CustomizeSkin(Screen parentScreenIn) {
    ...
    public void initGui() {
        ...
        for (EnumPlayerModelParts enumplayermodelparts : EnumPlayerModelParts.values()) {
            this.buttonList.add(new CustomizeSkin.ButtonPart(enumplayermodelparts.getPartId(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 + 24 * (i >> 1), 150, 20, enumplayermodelparts));
            ++i;
        }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            if (button.id == 210) {
                this.mc.displayGuiScreen(new ScreenCapeOF(this));
            }

            if (button.id == 200) {
                this.mc.gameSettings.saveOptions();
                this.mc.displayGuiScreen(this.parentScreen);
            } else if (button instanceof CustomizeSkin.ButtonPart) {
                EnumPlayerModelParts enumplayermodelparts = ((CustomizeSkin.ButtonPart) button).playerModelParts;
    ...
    class ButtonPart extends GuiButton {
        ...
        private ButtonPart(int p_i45514_2_, int p_i45514_3_, int p_i45514_4_, int p_i45514_5_, int p_i45514_6_, EnumPlayerModelParts playerModelParts) {
            super(p_i45514_2_, p_i45514_3_, p_i45514_4_, p_i45514_5_, p_i45514_6_, CustomizeSkin.this.func_175358_a(playerModelParts));
