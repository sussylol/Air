...
import net.minecraft.client.gui.inventory.Inventory;
import net.minecraft.client.main.GameConfiguration;
import net.minecraft.client.multiplayer.Connecting;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void updateDisplayMode() throws LWJGLException {
        ...
        if (displayWidth != displaymode.getWidth() || displayHeight != displaymode.getHeight()) {
            EventManager.call(new ScreenScaleUpdate());
        }
    ...
    public void displayGuiScreen(Screen screenIn) {
        ...
        if (screenIn != null) {
            ...
            screenIn.setWorldAndResolution(this, i, j);
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null && this.player != null) {
            if (this.player.getHealth() <= 0.0F) {
                ...
                this.displayGuiScreen(new SleepMP());
            }
        } else if (this.currentScreen != null && this.currentScreen instanceof SleepMP && !this.player.isPlayerSleeping()) {
            this.displayGuiScreen(null);
        }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        EventManager.call(new KeyInputEvent(k));
            ...
            while (this.gameSettings.keyBindInventory.isPressed()) {
                if (this.playerController.isRidingHorse()) {
                    ...
                    this.displayGuiScreen(new Inventory(this.player));
                }
            }
            ...
            while (this.gameSettings.keyBindChat.isPressed() && flag) {
                this.displayGuiScreen(new Chat());
            }
    ...
    public void dispatchKeypresses() {
        ...
        if (i != 0 && !Keyboard.isRepeatEvent()) {
            if (!(this.currentScreen instanceof Controls) || ((Controls) this.currentScreen).time <= getSystemTime() - 20L) {
                if (Keyboard.getEventKeyState()) {
