...
public abstract class Entity implements ICommandSender {
     ...
     */
    public void strafeToFrom(float strafe, float forward, float friction) {
        PlayerStrafeEvent event = new PlayerStrafeEvent(this.rotationYaw, strafe, forward, friction);
    ...
    public void readFromNBT(NBTTagCompound tagCompund) {
        try {
            ...
            this.setRenderYawHead(this.rotationYaw);
    ...
    public float getCollisionBorderSize() {
        return (float) VersionUtil.getExpandValue();
    }
    ...
    public Direction getHorizontalFacing() {
        return Direction.getHorizontal(MathHelper.floor_double((double) (this.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3);
    }
