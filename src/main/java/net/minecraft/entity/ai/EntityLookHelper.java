...
public class EntityLookHelper {
    ...
    public void onUpdateLook() {
        ...
        if (this.isLooking) {
            ...
            this.entity.renderYawHead = this.updateRotation(this.entity.renderYawHead, f, this.deltaLookYaw);
        } else {
            this.entity.renderYawHead = this.updateRotation(this.entity.renderYawHead, this.entity.renderYawOffset, 10.0F);
        }

        float f2 = MathHelper.wrapAngleTo180_float(this.entity.renderYawHead - this.entity.renderYawOffset);

        if (!this.entity.getNavigator().noPath()) {
            if (f2 < -75.0F) {
                this.entity.renderYawHead = this.entity.renderYawOffset - 75.0F;
            }
