...
public class EntityBodyHelper {
    ...
    public void updateRenderAngles() {
        ...
        if (d0 * d0 + d1 * d1 > 2.500000277905201E-7D) {
            ...
            this.theLiving.renderYawHead = this.computeAngleWithBound(this.theLiving.renderYawOffset, this.theLiving.renderYawHead, 75.0F);
            this.prevRenderYawHead = this.theLiving.renderYawHead;
            this.rotationTickCounter = 0;
        } else {
            float f = 75.0F;

            if (Math.abs(this.theLiving.renderYawHead - this.prevRenderYawHead) > 15.0F) {
                this.rotationTickCounter = 0;
                this.prevRenderYawHead = this.theLiving.renderYawHead;
            } else {
            ...
            this.theLiving.renderYawOffset = this.computeAngleWithBound(this.theLiving.renderYawHead, this.theLiving.renderYawOffset, f);
        }
    }
